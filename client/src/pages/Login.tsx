...
export default function Login({ onLogin }: LoginProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setError("");
    setTimeout(() => {
      if (email === "bpommerening@gmail.com" && password === "Brad1074$") {
        onLogin();
      } else {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 11, color: "oklch(0.55 0.18 145)", letterSpacing: "0.12em", fontFamily: "'JetBrains Mono', monospace", textTransform: "uppercase", marginBottom: 16 }}>
          Meet Atlas
        </div>
        <h1 style={{
          ...
          Your <span style={{ color: "oklch(0.55 0.18 145)", fontStyle: "italic" }}>full-time</span><br/>
          data team,<br/>
          built into one app.
        </h1>
        <p style={{ fontSize: 15, color: "oklch(0.50 0.02 40)", lineHeight: 1.6, maxWidth: 380 }}>
          Atlas by Brad Buys Houses connects to dozens of property databases, satellites, and softwares to bring you{" "}
      ...
      <div style={{
        ...
        <p style={{ fontSize: 14, color: "oklch(0.45 0.02 40)", marginBottom: 32 }}>
          I'm Atlas — <span style={{ color: "oklch(0.55 0.18 145)", fontWeight: 600 }}>your full-time data agent.</span><br/>
          Wisconsin's trusted cash home buyer.
        </p>
        ...
        <div style={{ marginTop: 32, fontSize: 11, color: "oklch(0.35 0.02 40)", textAlign: "center", fontFamily: "'JetBrains Mono', monospace" }}>
          Atlas by Brad Buys Houses · Private Access Only · WI Real Estate Intelligence
        </div>
      </div>
    </div>
  );
