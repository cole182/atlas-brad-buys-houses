    ...
    <div style={{ maxWidth: 1200 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 12, marginBottom: 24 }}>
        {[
          ...
          { label: "High Score (85+)", value: "11", color: "oklch(0.55 0.18 145)" },
        ].map(s => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
          <div>
            ...
            <select className="atlas-input" style={{ fontSize: 13 }}>
              <option>Dane County, WI</option>
              <option>Rock County, WI</option>
              <option>Door County, WI</option>
            </select>
          </div>
          <div>
        ...
        {types.map(t => (
          <button
            ...
            style={{
              ...
              background: filter === t ? "oklch(0.55 0.18 145)" : "transparent",
              borderColor: filter === t ? "oklch(0.55 0.18 145)" : "oklch(0.22 0.015 30)",
